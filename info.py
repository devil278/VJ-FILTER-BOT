...
API_ID = int(environ.get('API_ID', '23324908'))
API_HASH = environ.get('API_HASH', '0a34a410940bc7bb6c05daf35310ee84')
BOT_TOKEN = environ.get('BOT_TOKEN', "7342954599:AAHhEhjubCmdbaGwKPy8GOOsdGmBfUhDSUs")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002216741740'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6462069341').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002216741740').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002216741740') # give your force subscribe channel id here else leave it blank
